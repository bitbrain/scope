...
public class GameCreatedHandler extends AbstractGameClientHandler {

    public GameCreatedHandler(GameClient client, World world) {
        super(client, world);
    }
    ...
    public Class<?> getType() {
        return Responses.GameCreated.class;
    }
}
